      ...
      <div class="animated animatedFadeInUp fadeInUp">
        <div class="answer-heading">
          <div class="img-left">
            <img
              class="img-small"
              :src="this.question.url1"
              v-bind:class="[chosen ? 'chosen' : 'not-chosen']"
            />
          </div>
          ...
          <div class="img-right">
            <img
              class="img-small"
              :src="this.question.url2"
              v-bind:class="[chosen ? 'not-chosen' : 'chosen']"
            />
          </div>
        </div>
        <div class="answer-middle">
          ...
          <div class="answer-stats">
            ...
            <div
              class="answer-stats-1"
              v-bind:id="[chosen ? 'chosen-stats' : 'not-chosen-stats']"
            >
              <div class="big-percentage-1">{{ percentage1 }}%</div>
              <div class="stats-text-1">
                chose {{ this.question.option1 }} <br /><span
                  class="stats-people"
                  >({{ this.question.totalResponses1 }} people)</span
                >
              </div>
            </div>
            ...
            <div
              class="answer-stats-2"
              v-bind:id="[chosen ? 'not-chosen-stats' : 'chosen-stats']"
            >
              <div class="big-percentage-2">{{ percentage2 }}%</div>
              <div class="stats-text-2">
                chose {{ this.question.option2 }} <br /><span
                  class="stats-people"
                  >({{ this.question.totalResponses2 }} people)</span
                >
              </div>
            </div>
          </div>
